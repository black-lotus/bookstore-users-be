...
import (
	...
	"github.com/black-lotus/bookstore-users-be/repositories/users_repository"
	"github.com/black-lotus/bookstore-users-be/utils/mysql_utils"

	"github.com/black-lotus/bookstore-utils-go/logger"
	"github.com/black-lotus/bookstore-utils-go/rest_errors"
)
...
func (user *User) Get() rest_errors.RestErr {
	stmt, err := users_repository.Client.Prepare(queryGetUser)
	if err != nil {
...
func (user *User) Save() rest_errors.RestErr {
	stmt, err := users_repository.Client.Prepare(queryInsertUser)
	if err != nil {
...
func (user *User) Update() rest_errors.RestErr {
	stmt, err := users_repository.Client.Prepare(queryUpdateUser)
	if err != nil {
...
func (user *User) Delete() rest_errors.RestErr {
	stmt, err := users_repository.Client.Prepare(queryDeleteUser)
	if err != nil {
...
func (user *User) FindByStatus(status string) ([]User, rest_errors.RestErr) {
	stmt, err := users_repository.Client.Prepare(queryFindByStatus)
	if err != nil {
...
func (user *User) FindByEmailAndPassword() rest_errors.RestErr {
	stmt, err := users_repository.Client.Prepare(queryFindByEmailAndPassword)
	if err != nil {
